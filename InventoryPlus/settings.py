...
ALLOWED_HOSTS = ['ims.ahmed-haz.com', '127.0.0.1', 'localhost']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # to add base, navbar, and landing page on project root
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [ # to use global static fils
    BASE_DIR / "static",
]
